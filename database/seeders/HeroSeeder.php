...
class HeroSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $Mauga = hero::create(['nombre' => 'Mauga', 'rol' => 'tank', 'img_path' => 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/9ee3f5a62893091d575ec0a0d66df878597086374202c6fc7da2d63320a7d02e.png']);
        $Orisa = hero::create(['nombre' => 'Orisa', 'rol' => 'tank', 'img_path' => 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/71e96294617e81051d120b5d04b491bb1ea40e2933da44d6631aae149aac411d.png']);
        $Ramattra = hero::create(['nombre' => 'Ramattra', 'rol' => 'tank', 'img_path' => 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/3e0367155e1940a24da076c6f1f065aacede88dbc323631491aa0cd5a51e0b66.png']);
        $Reinhardt = hero::create(['nombre' => 'Reinhardt', 'rol' => 'tank', 'img_path' => 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/490d2f79f8547d6e364306af60c8184fb8024b8e55809e4cc501126109981a65.png']);
        $Roadhog = hero::create(['nombre' => 'Roadhog', 'rol' => 'tank', 'img_path' => 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/72e02e747b66b61fcbc02d35d350770b3ec7cbaabd0a7ca17c0d82743d43a7e8.png']);
        $Sigma = hero::create(['nombre' => 'Sigma', 'rol' => 'tank', 'img_path' => 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/cd7a4c0a0df8924afb2c9f6df864ed040f20250440c36ca2eb634acf6609c5e4.png']);
        $Winston = hero::create(['nombre' => 'Winston', 'rol' => 'tank', 'img_path' => 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/bd9c8e634d89488459dfc1aeb21b602fa5c39aa05601a4167682f3a3fed4e0ee.png']);
        ...
        $Cassidy = hero::create(['nombre' => 'Cassidy', 'rol' => 'dps', 'img_path' => 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/6cfb48b5597b657c2eafb1277dc5eef4a07eae90c265fcd37ed798189619f0a5.png']);
        $Echo = hero::create(['nombre' => 'Echo', 'rol' => 'dps', 'img_path' => 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/f086bf235cc6b7f138609594218a8385c8e5f6405a39eceb0deb9afb429619fe.png']);
        $Genji = hero::create(['nombre' => 'Genji', 'rol' => 'dps', 'img_path' => 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/4edf5ea6d58c449a2aeb619a3fda9fff36a069dfbe4da8bc5d8ec1c758ddb8dc.png']);
        $Hanzo = hero::create(['nombre' => 'Hanzo', 'rol' => 'dps', 'img_path' => 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/aecd8fa677f0093344fab7ccb7c37516c764df3f5ff339a5a845a030a27ba7e0.png']);
        $Junkrat = hero::create(['nombre' => 'Junkrat', 'rol' => 'dps', 'img_path' => 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/037e3df083624e5480f8996821287479a375f62b470572a22773da0eaf9441d0.png']);
        $Mei = hero::create(['nombre' => 'Mei', 'rol' => 'dps', 'img_path' => 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/1533fcb0ee1d3f9586f84b4067c6f63eca3322c1c661f69bfb41cd9e4f4bcc11.png']);
        $Pharah = hero::create(['nombre' => 'Pharah', 'rol' => 'dps', 'img_path' => 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/f8261595eca3e43e3b37cadb8161902cc416e38b7e0caa855f4555001156d814.png']);
        $Reaper = hero::create(['nombre' => 'Reaper', 'rol' => 'dps', 'img_path' => 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/2edb9af69d987bb503cd31f7013ae693640e692b321a73d175957b9e64394f40.png']);
        $Sojourn = hero::create(['nombre' => 'Sojourn', 'rol' => 'dps', 'img_path' => 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/a53bf7ad9d2f33aaf9199a00989f86d4ba1f67c281ba550312c7d96e70fec4ea.png']);
        $Soldado76 = hero::create(['nombre' => 'Soldado: 76', 'rol' => 'dps', 'img_path' => 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/20b4ef00ed05d6dba75df228241ed528df7b6c9556f04c8070bad1e2f89e0ff5.png']);
        $Sombra = hero::create(['nombre' => 'Sombra', 'rol' => 'dps', 'img_path' => 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/bca8532688f01b071806063b9472f1c0f9fc9c7948e6b59e210006e69cec9022.png']);
        $Symmetra = hero::create(['nombre' => 'Symmetra', 'rol' => 'dps', 'img_path' => 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/7f2024c5387c9d76d944a5db021c2774d1e9d7cbf39e9b6a35b364d38ea250ac.png']);
        $Torbjorn = hero::create(['nombre' => 'Torbjörn', 'rol' => 'dps', 'img_path' => 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/1309ab1add1cc19189a2c8bc7b1471f88efa1073e9705d2397fdb37d45707d01.png']);
        $Tracer = hero::create(['nombre' => 'Tracer', 'rol' => 'dps', 'img_path' => 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/a66413200e934da19540afac965cfe8a2de4ada593d9a52d53108bb28e8bbc9c.png']);
        ...
        $Mercy = hero::create(['nombre' => 'Mercy', 'rol' => 'supp', 'img_path' => 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/2508ddd39a178d5f6ae993ab43eeb3e7961e5a54a9507e6ae347381193f28943.png']);
        $Moira = hero::create(['nombre' => 'Moira', 'rol' => 'supp', 'img_path' => 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/000beeb5606e01497897fa9210dd3b1e78e1159ebfd8afdc9e989047d7d3d08f.png']);
        $Zenyatta = hero::create(['nombre' => 'Zenyatta', 'rol' => 'supp', 'img_path' => 'https://d15f34w2p8l1cc.cloudfront.net/overwatch/71cabc939c577581f66b952f9c70891db779251e8e70f29de3c7bf494edacfe4.png']);
